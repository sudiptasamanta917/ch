...
const arbiter = {
    ...
    getValidMoves : function ({position,castleDirection,prevPosition,piece,rank,file,playerId}) {
        ...
        if (piece.endsWith('k'))
            moves = [
                ...moves , 
                ...getCastlingMoves({position,castleDirection,piece,rank,file,playerId})
            ]
    ...
    isPlayerInCheck : function ({positionAfterMove, position, player,playerId}) {
        ...
        // console.log(playerId,"isplayerincheck");
    ...
    isStalemate : function(position,player,castleDirection,playerId) {
        const isInCheck = this.isPlayerInCheck({positionAfterMove: position, player,playerId})
    ...
    insufficientMaterial : function(position,playerId) {
