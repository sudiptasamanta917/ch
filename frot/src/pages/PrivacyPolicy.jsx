    ...
    return (
        <div className='m-5'>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to dynamoChess, the software program provided by the Company.</p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>Email:sadanipradeep11@gmail.com</p>
                </li>
                <li>
                    <p>Name: Pradeep Sadani</p>
                </li>
                <li>
                    <p>Phone:+919339091162</p>
                </li>
                <li>
                    <p>Address: 3rd floor, Fort Knox, 308, 6,Camac St, Kolkata, 700017</p>
                </li>
                {/* <li>
                    <p>Usage Data</p>
                </li> */}
