...
function Chess8by8() {
  ...
  const baseButton = `bg-yellow-300 text-white w-12 h-12 rounded-full flex items-center justify-center 
    shadow-[0_4px_0_#d1a000] transition-all duration-150 cursor-pointer`;
  ...
  return (
    <div className="w-full   bg-[url('/chess_yellow_green.jpg')] bg-cover bg-center bg-no-repeat">
        ...
        <AppContext.Provider value={providerState}>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-2  h-screen  overscroll-contain  ">
            ...
            <div className=" flex justify-center flex-col items-center h-full ">
              <div className="w-full min-w-[490px]   px-[50px] max-w-[740px] flex justify-center sm:justify-end pb-2">
                <PlayerProfile
                  name="Black"
              ...
              <Board />
              <div className="w-full min-w-[490px] px-[50px] max-w-[740px] flex justify-center sm:justify-start pt-2">
                <PlayerProfile
                  name="White"
                  avatar="https://i.imgur.com/uIgDDDd.jpg"
