  ...
  return (
    <div className="">
      <ResizableBox
        ...
        minConstraints={[300, 300]} // Minimum size for the container
        maxConstraints={[650, 650]} // Maximum size for the container
        lockAspectRatio={true} // Keep the container square
        onResize={onResize}
        resizeHandles={["se"]} // Allow resizing from bottom-right corner
        className="flex justify-center items-center"
        style={{
          "--tile-size": `${tileSize}px`, // Set tile size as a CSS variable
        }}
      >
